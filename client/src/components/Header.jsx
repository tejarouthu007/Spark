    ...
    <nav className="w-full bg-[#131515] border-b-4 border-[#38b137] p-4 min-h-20">
      ...
      <img src='logo.svg' className='w-32 sm:w-32' onClick={()=>{navigate('/')}}/>
        ...
        { isLoggedIn ?
          ...
          <button className="flex items-center font-semibold gap-2 bg-[#38b137] text-bold rounded-full px-5 py-1.5 text-[#fffafa] hover:bg-[#fffafa] hover:text-[#38b137] transition-all duration-300" onClick={()=>{navigate('/login')}}>Login</button>
        }
      ...
      {isMenuOpen && (
        <div className="md:hidden flex flex-col items-center gap-4 bg-[#131515] p-4 border-t border-[#38b137]">
          <button className="text-[#fffafa] hover:text-[#38b137] transition-colors duration-300" onClick={() => navigate("/dashboard")}>Dashboard</button>
